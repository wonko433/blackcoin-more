...
1. Clone the Bitcloud Core source code:
...
Bitcloud Core is now available at `./src/bitcloudd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/bitcloud"

    touch "/Users/${USER}/Library/Application Support/bitcloud/bitcloud.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/bitcloud/bitcloud.conf"

The first time you run bitcloudd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/bitcloud/debug.log

Other commands:
-------

    ./src/bitcloudd -daemon # Starts the bitcloud daemon.
    ./src/bitcloud-cli --help # Outputs a list of command-line options.
    ./src/bitcloud-cli help # Outputs a list of RPC commands when the daemon is running.
