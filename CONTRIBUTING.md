Contributing to BTDX Core
============================

The BTDX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BTDX Core project, and is not to be
confused with overall BTDX Network Protocol consensus changes.

Whether a pull request is merged into BTDX Core rests with the project merge
...
Patches that change BTDX consensus rules are considerably more involved than
...
Where a patchset proposes to change the BTDX consensus, it must have been
...
The project leader is the release manager for each BTDX Core release.
