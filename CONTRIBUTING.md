Contributing to Bitcloud Core
============================

The Bitcloud Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/LIMXTEC/Bitcloud/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bitcloud Core project, and is not to be
confused with overall Bitcloud Network Protocol consensus changes.

Whether a pull request is merged into Bitcloud Core rests with the project merge
...
Patches that change Bitcloud consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bitcloud consensus, it must have been
...
The project leader is the release manager for each Bitcloud Core release.
