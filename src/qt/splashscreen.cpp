...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Bitcloud Core");
    ...
    QString copyrightTextBitcloud = QChar(0xA9) + QString(" 2016-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcloud Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextBitcloud);
