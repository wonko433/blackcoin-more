    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select BTDX Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BTDX");
    ...
    ui->labelValueAfter->setText("0.00 BTDX");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BTDX");
    ui->labelValueFee->setText("0.00 BTDX");
