...
/* Bitcloud GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bitcloud"
#define QAPP_ORG_DOMAIN "bit-cloud.info"
#define QAPP_APP_NAME_DEFAULT "BTDX-Qt"
#define QAPP_APP_NAME_TESTNET "BTDX-Qt-testnet"
