...
BOOST_AUTO_TEST_CASE(coin_selection_tests)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK(!wallet.SelectCoinsMinConf( 1 * CENT, 1, 10, 0, vCoins, setCoinsRet, nValueRet));
        ...
        BOOST_CHECK(!wallet.SelectCoinsMinConf( 3 * CENT, 1, 10, 0, vCoins, setCoinsRet, nValueRet));
        ...
        BOOST_CHECK(!wallet.SelectCoinsMinConf(38 * CENT, 1, 10, 0, vCoins, setCoinsRet, nValueRet));
        // we can't even make 37 cents if we don't allow new coins even if they're from us
        BOOST_CHECK(!wallet.SelectCoinsMinConf(38 * CENT, 10, 10, 0, vCoins, setCoinsRet, nValueRet));
        // but we can make 37 cents if we accept new coins from ourself
        BOOST_CHECK( wallet.SelectCoinsMinConf(37 * CENT, 1, 10, 0, vCoins, setCoinsRet, nValueRet));
        ...
        // test randomness
        {
            ...
            BOOST_CHECK(wallet.SelectCoinsMinConf(50 * COIN, 1, 10, 0, vCoins, setCoinsRet , nValueRet));
            BOOST_CHECK(wallet.SelectCoinsMinConf(50 * COIN, 1, 10, 0, vCoins, setCoinsRet2, nValueRet));
            ...
            for (int j = 0; j < RANDOM_REPEATS; j++)
            {
                ...
                BOOST_CHECK(wallet.SelectCoinsMinConf(COIN, 1, 10, 0, vCoins, setCoinsRet , nValueRet));
                BOOST_CHECK(wallet.SelectCoinsMinConf(COIN, 1, 10, 0, vCoins, setCoinsRet2, nValueRet));
            ...
            for (int j = 0; j < RANDOM_REPEATS; j++)
            {
                // selecting 1 from 100 identical coins depends on the shuffle; this test will fail 1% of the time
                // run the test RANDOM_REPEATS times and only complain if all of them fail
                BOOST_CHECK(wallet.SelectCoinsMinConf(90*CENT, 1, 10, 0, vCoins, setCoinsRet , nValueRet));
                BOOST_CHECK(wallet.SelectCoinsMinConf(90*CENT, 1, 10, 0, vCoins, setCoinsRet2, nValueRet));
                if (equal_sets(setCoinsRet, setCoinsRet2))
                    fails++;
            }
            BOOST_CHECK_NE(fails, RANDOM_REPEATS);
...
BOOST_AUTO_TEST_CASE(ApproximateBestSubset)
{
    ...
    BOOST_CHECK(wallet.SelectCoinsMinConf(1003 * COIN, 1, 10, 0, vCoins, setCoinsRet, nValueRet));
